...
public class OrderPreservingProperties implements Map<String,String> {
    ...
    private static String[] splitKeyValue(String keyValueLine) {
        String line = Utils.clean(keyValueLine);
        if (line == null) {
            return null;
        }
        ...
        String key = Utils.clean(keyBuffer.toString());
        String value = Utils.clean(valueBuffer.toString());
    ...
    private static Map<String, String> toMapProps(String content) {
        ...
        while (scanner.hasNextLine()) {
            ...
            line = Utils.clean(scanner.nextLine());
